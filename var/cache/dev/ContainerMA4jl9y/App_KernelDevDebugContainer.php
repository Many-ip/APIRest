...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\PeliculasController' => 'getPeliculasControllerService',
    ...
    /**
     * Gets the public 'App\Controller\PeliculasController' shared autowired service.
     *
     * @return \App\Controller\PeliculasController
     */
    protected function getPeliculasControllerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/PeliculasController.php';

        return $this->services['App\\Controller\\PeliculasController'] = new \App\Controller\PeliculasController(($this->privates['App\\Repository\\PeliculasRepository'] ?? $this->getPeliculasRepositoryService()));
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6lk1llHTw6', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('olTk61Wd54', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\PeliculasRepository' => ['privates', 'App\\Repository\\PeliculasRepository', 'getPeliculasRepositoryService', false],
        ], [
    ...
    /**
     * Gets the private 'App\Repository\PeliculasRepository' shared autowired service.
     *
     * @return \App\Repository\PeliculasRepository
     */
    protected function getPeliculasRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/PeliculasRepository.php';

        return $this->privates['App\\Repository\\PeliculasRepository'] = new \App\Repository\PeliculasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kVUaOeQ1rq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
